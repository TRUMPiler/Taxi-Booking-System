            ...
            if($result->num_rows>0)
            {
                while($row=$result->fetch_array())
                {
                    ...
                    <div class='form-group'>
                        ...
                        <input type='text' class='form-control' name='lname' id='' placeholder='Enter your Last name' value=".$row["lname"]." disabled><br><br>
                    </div>
                    <div class='form-group'>
                        <label for='Age'>Birth Date:</label><br><br>
                        <input type='text' class='form-control' name='dob' id='' maxlength='3'value=".$row["dob"]." disabled><br><br>
                    </div>
                    <div class='form-group'>  
                        <label for='First name'>Gender: </label><br><br>
                        <input type='text' name='fname' id='' class='form-control' value=".$row["gender"]." placeholder='Enter your First name' disabled><br>
                    </div>
                    <div class='form-group'>
                        <label for='Address'>Address:</label><br><br>
                        <textarea name='address' class='form-control' id='' cols='1' rows='1' placeholder='Enter your Address' disabled>".$row["address"]."</textarea><br><br>
                    </div>
                    <hr>
                    <h2 style='text-align:left'>Contact Details:</h2>
                    <div class='form-group'>
                        <label for='Email'>Email ID: </label><br>
                        <input type='email' class='form-control' name='email' id='' value=".$row["email"]." placeholder='Enter your Email' disabled><br>
                        
                    </div><br>
                    <div class=form-group'>
                        <label for='Contact'>Contact:</label><br><br>
                        <input type='tel' class='form-control' id='' name='contact' value=".$row["contact"]." placeholder='Enter your contact number' maxlength='10' disabled><br><br>
                    </div>
