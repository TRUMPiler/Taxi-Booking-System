...
require_once "connection.php";
        ...
        if($tbname=="driver")
        {
            ...
            $query="insert into $tbname(`fname`, `lname`, `dob`, `gender`, `contact`, `address`, `email`,`password`,`image`) values('$fname','$lname','$dob','$gender',$contact,'$address','$email','$password','$fileName')";
