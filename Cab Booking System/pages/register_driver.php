...
<head>
    ...
    <link rel="stylesheet" href="styles_driver.css">
...
<div class="container">
        ...
        <form action="" method="post" >
            ...
            <div class="form-group">
                ...
                <textarea name="address" class="form-control" id="" cols="30" rows="4" placeholder="Enter your Address"></textarea><br><br><br><br>
            </div> 
            <h1>Vehicle Details: </h1>
            <hr><br>    
            <div class="form-group">
                <label for="Vehicle model">Company name: </label><br><br>
                <input type="text" class="form-control" name="company" id="" placeholder="Enter vehicle's Company name"><br><br>
            </div>
            <div class="form-group">
                <label for="Vehicle model">Vehicle name: </label><br><br>
                <input type="text" class="form-control" name="vehiclename" id="" placeholder="Enter vehicle name"><br><br>
            </div>
            <div class="form-group">
                <label for="Vehicle model">Vehicle Number: </label><br><br>
                <input type="text" class="form-control" name="vehiclenumber" id="" placeholder="XX-XX-XX-XXXX" pattern="[A-Z]{2}-[0-9]{2}-[A-Z]{2}-[0-9]{4}"><br><br> 
            </div>
